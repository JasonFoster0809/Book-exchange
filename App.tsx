  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50">
        <div className="h-10 w-10 animate-spin rounded-full border-b-2 border-[#034EA2]"></div>
      </div>
    );
  }
    ...
    <div className="flex min-h-screen flex-col bg-gray-50 font-sans text-gray-900">
      ...
      <main className="grow pb-20 sm:pb-0">
        <Routes>
          ...
          <Route
            path="/saved"
            element={<Navigate to="/my-items?tab=saved" replace />}
          />
          <Route
            path="/admin"
            element={
          ...
          <Route
            path="/post/:id"
            element={<Navigate to="/edit-item/:id" replace />}
          />
