...
const StepWizard = ({
  ...
  <div className="mx-auto mb-12 w-full max-w-4xl">
    <div className="relative flex items-center justify-between">
      ...
      <div
        className="absolute top-1/2 left-0 h-1 rounded-full bg-gradient-to-r from-blue-600 to-cyan-500 transition-all duration-500"
...
const PostItemPage: React.FC = () => {
  ...
  // --- SỬA LỖI Ở ĐÂY: Dùng trực tiếp thuộc tính của User ---
  ...
  return (
    <div className="min-h-screen pb-32 font-sans text-slate-800">
      ...
      <div className="pointer-events-none fixed inset-0 z-[-1] overflow-hidden">
        <div className="absolute top-0 left-0 h-[600px] w-full bg-gradient-to-b from-blue-50/50 to-transparent"></div>
      </div>
      ...
      {aiAnalyzing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/80 backdrop-blur-sm">
          <div className="relative w-full max-w-sm overflow-hidden rounded-3xl bg-white p-10 text-center shadow-2xl">
            <div className="absolute inset-0 z-0 bg-gradient-to-br from-indigo-50 to-purple-50"></div>
          ...
          <div className="glass-panel animate-enter rounded-[2.5rem] p-8">
            <div className="mb-8 flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-500 px-5 py-2.5 text-xs font-bold text-white shadow-lg transition-transform hover:scale-105"
              >
              ...
              <div className="relative mx-auto aspect-9/19 w-[300px] overflow-hidden rounded-[3rem] border-8 border-slate-900 bg-white shadow-2xl">
                ...
                <div className="hide-scrollbar h-full overflow-y-auto bg-slate-50">
                  <div className="relative aspect-square">
                    ...
                    />
                    <div className="absolute bottom-0 left-0 h-20 w-full bg-gradient-to-t from-black/60 to-transparent"></div>
            ...
            <div className="glass-panel flex flex-col rounded-[2.5rem] p-8">
              ...
              <div className="mt-auto space-y-3">
                <button
                  ...
                  className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-2xl bg-gradient-to-r from-[#00418E] to-[#0065D1] py-4 text-lg font-bold text-white transition-all hover:shadow-xl hover:shadow-blue-500/30 active:scale-95 disabled:opacity-70"
                >
                  {isSubmitting ? (
